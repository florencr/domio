-- Fix both: (1) Manager not seeing bills, (2) Missing reference codes
-- Run this in Supabase SQL Editor to fix everything at once

-- ========== PART 0: Ensure is_manager() exists ==========
...
-- ========== PART 1: Manager can see bills (RLS) ==========
...
-- ========== PART 2: Reference codes for bills ==========
...
-- ========== PART 3: Reference codes for expenses ==========
...
-- Backfill expenses without period (templates)
