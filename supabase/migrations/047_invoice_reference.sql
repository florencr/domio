-- Invoice references: unique per site+period+payer, with sequential number
...
-- Get next invoice number for site (atomic)
...
-- RLS: service role bypasses; policies restrict direct client access
