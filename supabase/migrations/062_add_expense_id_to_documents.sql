-- Add expense_id to documents (for expense-related uploads: invoice, contract)
-- Run this if you get: Could not find the 'expense_id' column of 'documents' in the schema cache
...
-- Add "invoice" category if not present
...
-- Update RLS: manager can access documents by building OR by expense
